...
const Movie = async ({
  ...
  const data = await (
    await fetch(
      `https://api.themoviedb.org/3/movie/${params.movieid}?api_key=${process.env.VITE_TMDB_API_KEY}`
    )
  ).json();
          ...
          <div className="left">
            <div className="upper">
              <div className="up">
                ...
                <p className="grey">2020</p>
                <p className="grey">4 Seasons</p>
                <p className="hd">HD</p>
              </div>
              <div className="down">
                <p className="UA">U/A 13+</p>
                <p>language, mature themes, tobacco use</p>
              </div>
            </div>
            <div className="lower">{data.overview}</div>
          </div>
          <div className="right">
            <div>
              <p>
            ...
            <div className="eachshow">
              ...
              <div className="text">
                ...
                <p>
                  ...
                  obcaecati dolor rerum soluta libero aliquid?
                </p>
              </div>
            </div>
            <div className="eachshow">
